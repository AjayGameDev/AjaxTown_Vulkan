...
set_target_properties(External::ktx PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/ktxd.lib"
  )

list(APPEND _cmake_import_check_targets External::ktx )
list(APPEND _cmake_import_check_files_for_External::ktx "${_IMPORT_PREFIX}/lib/ktxd.lib" )

# Import target "External::astcenc-avx2-static" for configuration "Debug"
set_property(TARGET External::astcenc-avx2-static APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(External::astcenc-avx2-static PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/astcenc-avx2-staticd.lib"
  )

list(APPEND _cmake_import_check_targets External::astcenc-avx2-static )
list(APPEND _cmake_import_check_files_for_External::astcenc-avx2-static "${_IMPORT_PREFIX}/lib/astcenc-avx2-staticd.lib" )
