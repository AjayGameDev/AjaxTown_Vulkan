...
import Engine.Core;
import Engine.Fence;
import Engine.Semaphore;
import Engine.CommandBuffer;
import Engine.CommandPool;
...
export class Renderer
{
    ...
    public:
            ...
            {
                vkCmdBindDescriptorSets(frameResources[currentFrame].graphicsCommandBuffer.GetHandle(),VK_PIPELINE_BIND_POINT_GRAPHICS,pipelineLayout,0,1,&descriptorSet,0,nullptr);
            }

            void BindDescriptorSetCompute(VkPipelineLayout& pipelineLayout,VkDescriptorSet& descriptorSet)
            {
                vkCmdBindDescriptorSets(frameResources[currentFrame].computeCommandBuffer.GetHandle(),VK_PIPELINE_BIND_POINT_COMPUTE,pipelineLayout,0,1,&descriptorSet,0,nullptr);
            }
